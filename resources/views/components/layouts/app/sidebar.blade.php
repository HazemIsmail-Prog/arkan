        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('')" class="grid">
                    ...
                    @endif
                    @if(auth()->user()->hasPermissionTo('view_all_requiredapproval'))
                        <flux:navlist.item icon="users" :href="route('required-approvals.index')" :current="request()->routeIs('required-approvals.index')" wire:navigate>{{ __('Required Approvals') }}</flux:navlist.item>
                    @endif
